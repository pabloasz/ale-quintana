...
- La foto del premio se redimensiona/comprime en el navegador y se guarda como data URL directo en la base (Postgres), no en un servicio de almacenamiento de archivos aparte — para una foto por rifa no vale la pena la complejidad extra de configurar algo como Vercel Blob. Si más adelante se quisieran fotos de mayor resolución o varias por rifa, ahí sí conviene migrar a almacenamiento de objetos.
